...
//   {
//     title: "Take Exams",
//     points: ["IPMAT Indore", "IPMAT Rohtak", "JIPMAT", "IIM K BMSAT"],
//   },
//   {
//     title: "Interview",
...
//   {/* New Dropdown for Target Year */}
//   <select
//     className="w-full h-10 px-3 border border-gray-300 rounded-md text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#833589]"
