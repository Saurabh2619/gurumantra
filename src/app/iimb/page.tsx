  ...
  <div className="container mx-auto px-4 max-w-7xl">
    ...
    <div className="max-w-4xl mx-auto bg-gray-50 p-8 rounded-xl shadow-lg">
      <p className="text-gray-700 leading-relaxed mb-6">
        The Indian Institute of Management Bangalore (IIMB), one of India’s premier institutions for management and
        interdisciplinary education, is set to launch its first-ever full-time undergraduate degree programmes—a major
        milestone in its academic journey. These pioneering four-year BSc (Honours) degrees in Economics and Data
        Science will be offered under the newly established School of Multidisciplinary Studies at IIMB’s upcoming Jigani
        campus. The programme is designed to shape responsible, future-ready individuals equipped to lead in fields where
        data, policy, business, and analytical thinking intersect.
      </p>
      <p className="text-gray-700 leading-relaxed">
        Launching in the 2026–27 academic year, this new undergraduate offering blends the academic depth of IIM
        Bangalore with the flexibility of the National Education Policy (NEP). Students will choose a major in either
        Economics or Data Science, with optional minors in Business, enabling them to build a well-rounded foundation.
        The curriculum also encourages interdisciplinary thinking through electives like Environmental Economics,
        Algorithmic Game Theory, Supply Chain Optimization, Big Data Computing, and more. With opportunities for
        international exchange, two internship terms, and modules on ethics, philosophy, and communication, the
        programme offers a holistic learning experience. Students also have the option to exit after 3 years with a
        degree, or continue for the full four-year Honours with Research. This bold academic step reflects IIM
        Bangalore’s vision to offer high-quality undergraduate education beyond traditional professional paths like
        engineering and medicine, helping shape a new generation of analytical thinkers, researchers, and business
        leaders.
      </p>
    </div>
  </div>
