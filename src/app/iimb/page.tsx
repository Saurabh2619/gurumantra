...
const CustomAccordionItem = ({ value, children, className }: AccordionItemProps) => {
  return <div className={cn("border-b", className)}>{children}</div>
}

const CustomAccordionTrigger = ({ children, onClick, isOpen, className }: AccordionTriggerProps) => {
  return (
    <button
      type="button"
      onClick={onClick}
...
const CustomAccordionContent = ({ children, isOpen, className }: AccordionContentProps) => {
...
export default function IPM() {
  ...
  const handleFAQClick = (value: string) => {
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="max-w-4xl mx-auto bg-gray-50 p-8 rounded-xl shadow-lg">
            <p className="text-gray-700 leading-relaxed mb-6">
              The Indian Institute of Management Bangalore (IIMB), one of India’s premier institutions for management
              and interdisciplinary education, is set to launch its first-ever full-time undergraduate degree
              programmes—a major milestone in its academic journey. These pioneering four-year BSc (Honours) degrees in
              Economics and Data Science will be offered under the newly established School of Multidisciplinary Studies
              at IIMB’s upcoming Jigani campus. The programme is designed to shape responsible, future-ready individuals
              equipped to lead in fields where data, policy, business, and analytical thinking intersect.
            </p>
            <p className="text-gray-700 leading-relaxed">
              Launching in the 2026–27 academic year, this new undergraduate offering blends the academic depth of IIM
              Bangalore with the flexibility of the National Education Policy (NEP). Students will choose a major in
              either Economics or Data Science, with optional minors in Business, enabling them to build a well-rounded
              foundation. The curriculum also encourages interdisciplinary thinking through electives like Environmental
              Economics, Algorithmic Game Theory, Supply Chain Optimization, Big Data Computing, and more. With
              opportunities for international exchange, two internship terms, and modules on ethics, philosophy, and
              communication, the programme offers a holistic learning experience. Students also have the option to exit
              after 3 years with a degree, or continue for the full four-year Honours with Research. This bold academic
              step reflects IIM Bangalore’s vision to offer high-quality undergraduate education beyond traditional
              professional paths like engineering and medicine, helping shape a new generation of analytical thinkers,
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="flex flex-wrap justify-center gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 max-w-sm w-full">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold text-[#833589] mb-4">IIM B UG</h3>
      ...
      <div className="flex flex-col min-h-[100dvh]">
        <main className="flex-1">
          ...
          <section className="py-16 bg-white">
            <div className="container mx-auto px-4 max-w-7xl">
              ...
              <p className="text-gray-600 text-center max-w-3xl mx-auto mb-10">
                Our students share their journey from preparation to success. Listen to their experiences, challenges,
                and how IPM Careers helped them achieve their dreams of getting into prestigious IIMs. These
                testimonials reflect our commitment to excellence and personalized coaching.
              </p>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center max-w-6xl mx-auto">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg shadow-md border-l-4 border-[#F3B51A]">
                    ...
                    <p className="text-gray-600">
                      Learn about the strategies and techniques that helped our students excel in their IPMAT
                      preparation and secure admissions in top IIMs.
                    </p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg shadow-md border-l-4 border-[#833589]">
          ...
          <section className="py-16 bg-gray-50">
            <div className="container mx-auto px-4 max-w-7xl">
              <h2 className="text-3xl md:text-4xl font-bold text-center mb-6 text-[#833589]">
                IIMB Launches UG Programme: <span className="text-[#F3B51A]">4-Year Courses in Economics and Data Science:</span>{" "}
               Check All Details
              </h2>
              <div className="prose prose-lg prose-gray max-w-7xl mx-auto dark:prose-invert leading-relaxed space-y-4">
                <p>
                  In an exciting development, the Indian Institute of Management Bangalore (IIMB) is set to launch its
                  very first undergraduate program, kicking off in the academic year 2026–27. Renowned for its
                  excellence in postgraduate management education, IIMB is now stepping into the undergraduate arena,
                  offering 4-year B.Sc. (Hons) degrees in Economics and Data Science. This initiative isn’t just about
                  expanding course offerings; it’s about transforming the landscape of undergraduate education in India.
                </p>

                <h3 className="text-2xl font-bold text-[#833589]">Overview of the Undergraduate Programmes</h3>
                <ul className="list-disc list-inside space-y-2">
                  <li>B.Sc. (Hons) in Data Science (with minors in Economics & Business)</li>
                  <li>B.Sc. (Hons) in Economics (with minors in Data Science & Business)</li>
                </ul>
                <p>
                  These programs are crafted to provide a rich, multi-layered academic experience that blends core
                  subject knowledge with a broad interdisciplinary approach. Whether you’re drawn to numbers, human
                  behavior, policy, or technology, these courses will give you a well-rounded foundation.
                </p>

                <h3 className="text-2xl font-bold text-[#833589]">Key Features of the Programmes</h3>
                <ul className="list-disc list-inside space-y-2">
                ...
                <p>Students won’t just “study” subjects—they’ll immerse themselves in them.</p>

                <h3 className="text-2xl font-bold text-[#833589]">Curriculum & Subjects</h3>
                <h4 className="text-xl font-semibold text-[#833589]">Economics Programme:</h4>
                <p>The Economics stream will delve deeper than just theory. It will explore areas such as:</p>
                <ul className="list-disc list-inside space-y-2">
                  <li>Public Policy</li>
                ...
                <p>You’ll discover how economic models function in real-world policies and markets.</p>

                <h4 className="text-xl font-semibold text-[#833589]">Data Science Programme:</h4>
                <p>The Data Science stream will cover cutting-edge topics like:</p>
                <ul className="list-disc list-inside space-y-2">
                ...
                <p>
                  You won’t merely analyze numbers; you’ll learn to tackle business, social, and policy challenges using
                  data.
                </p>

                <h3 className="text-2xl font-bold text-[#833589]">Admission Process</h3>
                <h4 className="text-xl font-semibold text-[#833589]">Eligibility Criteria:</h4>
                ...
                <h4 className="text-xl font-semibold text-[#833589]">Entrance Test + Interview:</h4>
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <li>A Personal Interview for candidates who make the shortlist</li>
                </ul>
                <p>
                  The aim is to choose students who can think critically, rather than just those who can score high
                  marks.
                </p>

                <h3 className="text-2xl font-bold text-[#833589]">Application Timeline</h3>
                <p>
                  Applications for the first batch will kick off in September 2025. So, if you’re currently in Class 11
                  or 12, be sure to circle that date on your calendar!
                </p>

                <h3 className="text-2xl font-bold text-[#833589]">NEP Alignment and Exit Options</h3>
                <p>The programs are in line with the National Education Policy (NEP) and are designed as:</p>
                <ul className="list-disc list-inside space-y-2">
                  <li>4-year B.Sc. (Hons) degrees</li>
                  <li>An exit option after 3 years with a suitable qualification</li>
                </ul>
                <p>
                  This flexibility caters to both those who want to dive deep into learning and those looking to jump
                  into the workforce early.
                </p>

                <h3 className="text-2xl font-bold text-[#833589]">Class Size & Expansion Plan</h3>
                <ul className="list-disc list-inside space-y-2">
                  <li>Initial intake: 40 students per course</li>
                  <li>Target growth: Up to 640 students per program</li>
                </ul>
                <p>
                  This gradual growth strategy ensures that each student receives personal attention, maintains academic
                  rigor, and achieves quality outcomes.
                </p>

                <h3 className="text-2xl font-bold text-[#833589]">Campus and Facilities</h3>
                <p>
                  The undergraduate courses will take place at IIMB’s new campus, conveniently located near Bannerghatta
                  National Park. This site is celebrated for:
                </p>
                <ul className="list-disc list-inside space-y-2">
                ...
                <p>Just picture studying in a setting where nature and knowledge come together.</p>

                <h3 className="text-2xl font-bold text-[#833589]">Programme Fee and Scholarships</h3>
                <ul className="list-disc list-inside space-y-2">
                  <li>Annual Fee: ₹8.5 lakh</li>
                  <li>Scholarships and fee concessions will be offered (details to follow)</li>
                </ul>
                <p>IIMB is committed to fostering diversity and inclusivity within its classrooms.</p>

                <h3 className="text-2xl font-bold text-[#833589]">Programme Governance</h3>
                <p>
                  These undergraduate programs will be overseen by a new School of Multidisciplinary Studies, ensuring:
                </p>
                <ul className="list-disc list-inside space-y-2">
                ...
                <h3 className="text-2xl font-bold text-[#833589]">Why UG Now?</h3>
                <p>Though proposed in 2017, IIMB is launching it now because:</p>
                <p className="italic">
                  “There is a shortage of high-quality undergraduate programmes outside engineering and medicine,” said
                  Director Rishikesha T. Krishnan.
                </p>
                <p>The NEP and changing educational landscape made this the perfect time to launch.</p>

                <h3 className="text-2xl font-bold text-[#833589]">Comparison With Other IIM Programmes</h3>
                <p>
                  When we compare IIMB’s offerings to those of IIM Indore or IIM Rohtak, which feature 5-year Integrated
                  Programmes in Management (IPM) that blend undergraduate and MBA studies, IIMB stands out with its
                  unique 4-year undergraduate degree.
                </p>
                <p>What does this mean for students?</p>
                <ul className="list-disc list-inside space-y-2">
                  <li>More flexibility in their academic journey</li>
                  <li>No obligation to continue with a postgraduate degree at IIM</li>
                  <li>A deeper focus on undergraduate-level knowledge and skills</li>
                </ul>

                <h3 className="text-2xl font-bold text-[#833589]">Vision and Future Outlook</h3>
                <ul className="list-disc list-inside space-y-2">
                  <li>Natural Sciences</li>
                  <li>Sustainability Studies</li>
                </ul>
                <p>
                  This shows a commitment to a long-term vision of becoming a leader in comprehensive undergraduate
                  education.
                </p>

                <h3 className="text-2xl font-bold text-[#833589]">What Makes This Programme Unique</h3>
                <p>
                  IIMB’s undergraduate courses merge the rigorous standards of an IIM education with the inquisitive
                  spirit and adaptability of liberal arts learning.
                </p>
                <p>In essence, it’s designed to nurture:</p>
                <ul className="list-disc list-inside space-y-2">
                  <li>Smart decision-makers</li>
                  <li>Analytical thinkers</li>
                  <li>Versatile professionals who are ready to tackle future challenges</li>
                </ul>
                ...
                <div className="w-full">
                  <CustomAccordionItem value="item-1">
                    ...
                    >
                      Is the UG programme at IIMB integrated with an MBA like other IIMs?
                    </CustomAccordionTrigger>
                    <CustomAccordionContent isOpen={openFAQ === "item-1"} className="text-gray-700 text-lg">
                      No, it’s a standalone 4-year B.Sc. (Hons) programme, separate from a 5-year integrated MBA.
                  ...
                  <CustomAccordionItem value="item-2">
                    ...
                    <CustomAccordionContent isOpen={openFAQ === "item-2"} className="text-gray-700 text-lg">
                      Yes, according to the National Education Policy (NEP), you can choose to exit early after
                  ...
                  <CustomAccordionItem value="item-3">
                    ...
                    <CustomAccordionContent isOpen={openFAQ === "item-3"} className="text-gray-700 text-lg">
                      Fee concessions and scholarships will be offered based on financial need and eligibility.
                    </CustomAccordionContent>
                  </CustomAccordionItem>
                  <CustomAccordionItem value="item-4">
                    ...
                    <CustomAccordionContent isOpen={openFAQ === "item-4"} className="text-gray-700 text-lg">
                      Admissions for the inaugural batch will begin in September 2025.
                    </CustomAccordionContent>
                  </CustomAccordionItem>
                  <CustomAccordionItem value="item-5">
                    ...
                    <CustomAccordionContent isOpen={openFAQ === "item-5"} className="text-gray-700 text-lg">
                      Classes will be held at IIMB’s new campus located near Bannerghatta National Park in Bengaluru.
                    </CustomAccordionContent>
                  </CustomAccordionItem>
                </div>
              </div>
